...
def last_modify(request):
    if request.method =="POST":
        # Retrieve the instance of YourModel
        instance = EmpDetails.objects.first(last_modified=last_modified)  # Retrieve any instance or use a filter to get a specific instance
